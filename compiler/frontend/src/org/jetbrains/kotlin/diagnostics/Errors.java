...
public interface Errors {
    ...
    DiagnosticFactory1<PsiElement, InferenceErrorData> TYPE_INFERENCE_INCORPORATION_ERROR = DiagnosticFactory1.create(ERROR);
    ...
    ImmutableSet<? extends DiagnosticFactory<?>> TYPE_INFERENCE_ERRORS = ImmutableSet.of(
            ...
            TYPE_INFERENCE_UPPER_BOUND_VIOLATED, TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH, TYPE_INFERENCE_INCORPORATION_ERROR);
