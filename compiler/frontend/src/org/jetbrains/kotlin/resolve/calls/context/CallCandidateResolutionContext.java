...
public final class CallCandidateResolutionContext<D extends CallableDescriptor> extends CallResolutionContext<CallCandidateResolutionContext<D>> {
    ...
    @NotNull
    public final CandidatePerformMode candidatePerformMode;
    ...
    private CallCandidateResolutionContext(
        ...
        super(trace, scope, call, expectedType, dataFlowInfo, contextDependency, checkArguments, resolutionResultsCache,
              dataFlowInfoForArguments, callChecker, symbolUsageValidator, additionalTypeChecker, statementFilter, isAnnotationContext, 
        ...
        this.candidatePerformMode = candidatePerformMode;
    }
    ...
    public static <D extends CallableDescriptor> CallCandidateResolutionContext<D> create(
        ...
        return new CallCandidateResolutionContext<D>(
                ...
                candidatePerformMode, context.isAnnotationContext, context.collectAllCandidates, context.insideCallChain);
    }
    ...
    public static <D extends CallableDescriptor> CallCandidateResolutionContext<D> createForCallBeingAnalyzed(
        ...
        return new CallCandidateResolutionContext<D>(
                ...
                ReceiverValue.NO_RECEIVER, CandidatePerformMode.FULLY, context.isAnnotationContext, context.collectAllCandidates, context.insideCallChain);
    }
    ...
    protected CallCandidateResolutionContext<D> create(
        ...
        return new CallCandidateResolutionContext<D>(
                ...
                explicitExtensionReceiverForInvoke, candidatePerformMode, isAnnotationContext, collectAllCandidates, insideSafeCallChain);
    }
}
