...
fun box(): String {
    ...
    if (enclosingMethod != "LambdaInLocalClassSuperCall\$box\$L") return "ctor: $enclosingMethod"

    val enclosingClass = javaClass.getEnclosingClass()!!.getName()
    if (enclosingClass != "LambdaInLocalClassSuperCall\$box\$L") return "enclosing class: $enclosingClass"
