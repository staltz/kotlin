    ...
    public static class Tests extends AbstractJetDiagnosticsTest {
        ...
        public static class Inference extends AbstractJetDiagnosticsTest {
            ...
            public static class CommonSystem extends AbstractJetDiagnosticsTest {
                ...
                @TestMetadata("kt8218.kt")
                public void testKt8218() throws Exception {
                    String fileName = JetTestUtils.navigationMetadata("compiler/testData/diagnostics/tests/inference/commonSystem/kt8218.kt");
                    doTest(fileName);
                }
