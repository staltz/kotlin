...
public class ConstraintSystemTestGenerated extends AbstractConstraintSystemTest {
    ...
    public static class Interdependency extends AbstractConstraintSystemTest {
        public void testAllFilesPresentInInterdependency() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/constraintSystem/interdependency"), Pattern.compile("^(.+)\\.constraints$"), true);
        }

        @TestMetadata("interdependency1.constraints")
        public void testInterdependency1() throws Exception {
            String fileName = JetTestUtils.navigationMetadata("compiler/testData/constraintSystem/interdependency/interdependency1.constraints");
            doTest(fileName);
        }

        @TestMetadata("interdependency2.constraints")
        public void testInterdependency2() throws Exception {
            String fileName = JetTestUtils.navigationMetadata("compiler/testData/constraintSystem/interdependency/interdependency2.constraints");
            doTest(fileName);
        }

        @TestMetadata("interdependency3.constraints")
        public void testInterdependency3() throws Exception {
            String fileName = JetTestUtils.navigationMetadata("compiler/testData/constraintSystem/interdependency/interdependency3.constraints");
            doTest(fileName);
        }
    }
