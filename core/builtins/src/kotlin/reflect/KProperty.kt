...
public interface KProperty<out R> : KCallable<R> {
     ...
     */
    public interface Getter<out R> : Accessor<R>, KCallable<R>
}
...
public interface KMutableProperty<R> : KProperty<R> {
     ...
     */
    public interface Setter<R> : KProperty.Accessor<R>, KCallable<Unit>
}
...
public interface KProperty0<out R> : KProperty<R> {
    ...
    public interface Getter<out R> : KProperty.Getter<R>, KFunction<R>, () -> R
}
...
public interface KMutableProperty0<R> : KProperty0<R>, KMutableProperty<R> {
    ...
    public interface Setter<R> : KMutableProperty.Setter<R>, KFunction<Unit>, (R) -> Unit
}
...
public interface KProperty1<T, out R> : KProperty<R> {
    ...
    public interface Getter<T, out R> : KProperty.Getter<R>, KFunction<R>, (T) -> R
}
...
public interface KMutableProperty1<T, R> : KProperty1<T, R>, KMutableProperty<R> {
    ...
    public interface Setter<T, R> : KMutableProperty.Setter<R>, KFunction<Unit>, (T, R) -> Unit
}
...
public interface KProperty2<D, E, out R> : KProperty<R> {
    ...
    public interface Getter<D, E, out R> : KProperty.Getter<R>, KFunction<R>, (D, E) -> R
}

/**
 * Represents an extension `var`-property, operations on which take two receivers as parameters.
 */
public interface KMutableProperty2<D, E, R> : KProperty2<D, E, R>, KMutableProperty<R> {
    ...
    public interface Setter<D, E, R> : KMutableProperty.Setter<R>, KFunction<Unit>, (D, E, R) -> Unit
}
