...
public class ConstraintSystemImpl : ConstraintSystem {
    ...
    private val originalToVariables = HashMap<TypeParameterDescriptor, TypeParameterDescriptor>()
    private val variablesToOriginal = HashMap<TypeParameterDescriptor, TypeParameterDescriptor>()
    ...
    private fun createNewConstraintSystemFromThis(
        ...
        newSystem.usedInBounds.putAll(usedInBounds)
