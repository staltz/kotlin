 ...
 *
 * This class is conceptually abstract, but in fact concrete: all methods from reflection API should be implemented here
 * and throw informative exceptions (see KotlinReflectionNotSupportedError)
 */
public class CallableReference implements KCallable {
    ...
    /**
     * @return Kotlin name of the callable, the one which was declared in the source code (@platformName can't change it)
     */
    @Override
