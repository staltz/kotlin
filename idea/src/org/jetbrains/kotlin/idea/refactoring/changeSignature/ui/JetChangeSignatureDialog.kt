...
public class JetChangeSignatureDialog(
    ...
    private fun getPresentationName(item: ParameterTableModelItemBase<JetParameterInfo>): String {
        ...
        return if (parameter == myParametersTableModel.getReceiver()) "<receiver>" else parameter.getName()
    }

    private fun getColumnTextMaxLength(nameFunction: Function1<ParameterTableModelItemBase<JetParameterInfo>, String?>) =
            myParametersTableModel.getItems().map { nameFunction(it)?.length() ?: 0 }.max() ?: 0
    ...
    override fun getTableEditor(table: JTable, item: ParameterTableModelItemBase<JetParameterInfo>): JBTableRowEditor? {
        return object : JBTableRowEditor() {
            ...
            override fun prepareEditor(table: JTable, row: Int) {
                ...
                for (columnInfo in myParametersTableModel.getColumnInfos()) {
                    ...
                    if (JetCallableParameterTableModel.isTypeColumn(columnInfo)) {
                        ...
                        checkBox.addItemListener {
                            ...
                            (myParametersTableModel as JetFunctionParameterTableModel).setReceiver(newReceiver)
                            updateSignature()
                            updateNameEditor()
                        }
                        component = checkBox
                    ...
                    if (editor != null) {
                        ...
                        editor.setPreferredWidth(table.getWidth() / myParametersTableModel.getColumnCount())
                    }
            ...
            override fun getValue(): JBTableRow {
                return object : JBTableRow {
                    override fun getValueAt(column: Int): Any? {
                        val columnInfo = myParametersTableModel.getColumnInfos()[column]
    ...
    override fun calculateSignature(): String {
        val changeInfo = evaluateChangeInfo(myParametersTableModel,
    ...
    override fun canRun() {
        ...
        val parameterInfos = myParametersTableModel.getItems()
